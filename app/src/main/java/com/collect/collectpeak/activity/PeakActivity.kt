...
class PeakActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FragmentUtil.replace(R.id.container,supportFragmentManager,PeakTimeFragment.newInstance(data),true,PeakTimeFragment.javaClass.simpleName,ANIM_RIGHT_LEFT)
